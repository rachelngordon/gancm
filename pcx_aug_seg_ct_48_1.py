...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_aug_mask.py --exp_name pcx_seg_ct_aug_48_1245 --test_fold 3 --epochs 500 --batch_size 48 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_mask/norm_mask_neg1pos1_fold'", 0, 1),
    ("python3 ~/pcxgan/train_pcxgan_aug_mask.py --exp_name pcx_seg_ct_aug_48_1345 --test_fold 2 --epochs 500 --batch_size 48 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_mask/norm_mask_neg1pos1_fold'", 2, 3)
]
