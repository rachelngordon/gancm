...
import numpy as np
from . import modules_ct_mask as modules
import loss
import evaluate
...
class PCxGAN_ct(kr.Model):
	...
	def train_generator(self, latent_vector, segmentation_map, labels, image, mean, variance):
		...
		with tf.GradientTape() as tape:
			...
			total_loss =  kl_loss + feature_loss + ssim_loss + mae_loss
	...
	def train_step(self, data):
		...
		(feature_loss, kl_loss, ssim_loss, mae_loss) = self.train_generator(
