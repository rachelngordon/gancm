...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_mask.py --exp_name pcx_test --test_fold 5 --epochs 5 --epoch_interval 1 --batch_size 1 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_mask/norm_mask_neg1pos1_fold'", 0)
]
