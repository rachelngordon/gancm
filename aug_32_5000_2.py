...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_aug.py --exp_name pcx_aug_32_1245 --test_fold 3 --epochs 5000 --batch_size 32 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_paired/norm_neg1pos1_fold'", 0, 1)
    ("python3 ~/pcxgan/train_pcxgan_aug.py --exp_name pcx_aug_32_1345 --test_fold 2 --epochs 5000 --batch_size 32 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_paired/norm_mask_neg1pos1_fold'", 2, 3)
]
