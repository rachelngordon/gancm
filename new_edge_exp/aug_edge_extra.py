...
command_lines = [
    ("python3 ~/pcxgan/train_gancm_aug_mask.py --exp_name pcx_edge_thresh_ct_aug_16_2345 --test_fold 1 --epochs 500 --batch_size 16 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_edge_threshold/norm_mask_neg1pos1_fold'", 0, 1),
    ("python3 ~/pcxgan/train_gancm_aug_mask.py --exp_name pcx_edge_thresh_ct_aug_32_2345 --test_fold 1 --epochs 500 --batch_size 32 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_edge_threshold/norm_mask_neg1pos1_fold'", 2, 3)
]
