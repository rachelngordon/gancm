...
command_lines = [
    ("python3 train_pcxgan_ct.py --exp_name pcx_fold2345_1000 --test_fold 1 --epochs 1000 --batch_size 32", 0),
    ("python3 train_pix2pix.py --exp_name p2p_fold2345_1000 --test_fold 1 --epochs 1000", 1)
]
