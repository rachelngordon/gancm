...
command_lines = [
    ("python3 ~/gancm/train_uvit.py --exp_name uvit_no_eq_2345 --test_fold 1 --epochs 500 --batch_size 1 --data_path '/grand/EVITA/ct-mri/data/CV/no_eq_paired/norm_neg1pos1_fold'", 0)
]
