...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_no_mask.py --exp_name pcx_aug_test --test_fold 5 --epochs 10 --epoch_interval 1 --batch_size 1 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_paired/norm_neg1pos1_fold'", 0)
]
