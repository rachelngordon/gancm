...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_mask.py --exp_name pcx_seg_ct_no_aug_32_2345_2000 --test_fold 1 --epochs 2000 --epoch_interval 100 --batch_size 32 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_mask/norm_mask_neg1pos1_fold'", 0)
]
