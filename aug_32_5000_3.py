...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_aug.py --exp_name pcx_no_mask_aug_32_2345_5000 --test_fold 1 --epochs 5000 --batch_size 32 --epoch_interval 250 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_paired/norm_neg1pos1_fold'", 0, 1)
]
