...
command_lines = [
    ("python3 ~/gancm/train_gancm_aug_mask.py --exp_name bin_edge_aug_32_4000_2345 --test_fold 1 --epochs 4000 --batch_size 32 --data_path '/eagle/EVITA/ct-mri/data/CV/new_edge/avg_eq_edge_threshold/norm_mask_neg1pos1_fold'", 0, 1)]
