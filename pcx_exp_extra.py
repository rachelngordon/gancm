...
command_lines = [
    ("python3 ~/pcxgan/train_pcxgan_aug_no_mask.py --exp_name pcx_no_mask_aug_48_2345 --test_fold 1 --epochs 500 --batch_size 48 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_paired/norm_neg1pos1_fold'", 0, 1),
    ("python3 ~/pcxgan/train_pcxgan_aug_no_mask.py --exp_name pcx_no_mask_aug_32_2345 --test_fold 1 --epochs 500 --batch_size 32 --data_path '/grand/EVITA/ct-mri/data/CV/avg_eq_paired/norm_neg1pos1_fold'", 2, 3)
]
