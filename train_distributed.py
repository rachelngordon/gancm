...
command_lines = [
    ("python3 train_pix2pix.py --exp_name p2p_fold1234 --test_fold 5", 0),
    ("python3 train_pix2pix.py --exp_name p2p_fold1235 --test_fold 4", 1),
    ("python3 train_pix2pix.py --exp_name p2p_fold1245 --test_fold 3", 2),
    ("python3 train_pix2pix.py --exp_name p2p_fold1345 --test_fold 2", 3)
]
